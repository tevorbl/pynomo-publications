...
#    du = 105.6640 -   417.332/((2.65 - rhos) + 100*rhos/cw) +  27.94*math.log(Tu*1.102293/rhos )
    t1 = 105.6640 + 27.94*math.log(Tu*1.102293/rhos ) - du
    t2 = 417.332/t1 - (2.65 - rhos)
    cw = 100*rhos/t2
...
block_params0 = {
    ...
    'transform_ini': False,
    'isopleth_values': [[math.sqrt(left_scale['u_min'] * left_scale['u_max']), \
                         'x', \
...
Nomogen(fcw, main_params)  # generate nomogram for pendulum() function
