...
left_scale_psi = {
    'tag': 'left',
    'u_min': left_scale['u_min'] * psi_per_MPa,
    'u_max': left_scale['u_max'] * psi_per_MPa,
    'extra_titles':[
        {'dx':-0.1,
         'dy':0.11,
         'text':r'$\small psi$',
...
middle_scale_feet = {
    'tag': 'middle',
    'u_min': middle_scale['u_min'] * feet_per_metre,
    'u_max': middle_scale['u_max'] * feet_per_metre,
    'extra_titles':[
        {'dx':-0.1,
         'dy':0.11,
         'text':r'$\small ft$',
...
block_1_params={
    'block_type':'type_9',
    'f1_params': left_scale_psi,
    'f2_params': middle_scale_feet,
    'f3_params': right_scale_in,
...
for i in [left_scale, left_scale_psi, right_scale, right_scale_in]:
    for k in range(11):
